...
MyProjectApi - JavaScript client for my_project_api
...
```shell
npm install my_project_api --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your my_project_api from, and run:
...
```javascript
var MyProjectApi = require('my_project_api');


var api = new MyProjectApi.DefaultApi()
